<template>
 <div class="flex justify-between bg-first w-full shadow-xl py-1">
  <div class="flex">
    <div class="flex mx-3 p-1">
     <a href="/" class="my-auto">
      <svg xmlns="http://www.w3.org/2000/svg" class="font-semibold my-auto text-white h-10 w-10 hover:text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
