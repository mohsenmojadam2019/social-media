<template>
 <div class="flex justify-between items-center bg-first w-full shadow-xl py-1">
  <div class="flex items-center"> 
    <div class="rounded-4xl mx-3">
      <form @submit.prevent="search" class="flex">
       <input type="text" v-model="searchQuery" required class="w-96 py-2.5 px-3 text-lg lg:text-xl xl:text-xl 2xl:text-xl outline-none focus:border-b-2 border-tiruhakim rounded-l-3xl" placeholder="">
       <button type="submit" class="capitalize bg-second rounded-r-3xl lg:rounded-r-3xl xl:rounded-r-3xl 2xl:rounded-r-3xl text-xl lg:text-3xl xl:text-2xl 2xl:text-2xl py-2.5 px-4 my-auto" >
    ...
    <div class="font-medium text-white text-xl mx-5 hidden lg:inline xl:inline 2xl:inline">
     <ul class="flex items-center list-style-none">
       <li class="mx-4">
        <a href="/">
          <svg xmlns="http://www.w3.org/2000/svg" class="font-semibold my-auto text-white w-12 hover:text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <li class="mx-4">
        <a href="friend">
         <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-people text-white w-12" viewBox="0 0 16 16">
      ...
      <li class="mx-4">
        <a href="/chat">
         <svg xmlns="http://www.w3.org/2000/svg" class="w-12 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <li class="mx-4">
        <a href="/video">
         <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-play-btn text-white w-12" viewBox="0 0 16 16">
      ...
      <li>
       <div class="hidden md:inline mx-3">
